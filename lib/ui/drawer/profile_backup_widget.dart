...
class _ProfilePageState extends State<ProfilePage> {
  ...
  void initState() {
    ...
    userDataFuture = DBHelper.getUserData().then((userData) {
      ...
      String mongoId = userData['mongoId'] ?? ''; // Replace 'mongoId' with the actual key
      ...
      body: FutureBuilder(
        ...
        builder: (context, snapshot) {
          if (snapshot.connectionState == ConnectionState.waiting) {
            ...
            Widget additionalInfoWidget = _buildAdditionalInfo(currentStatus, userData);
...
Widget _buildUserInfo(String label, String value) {
  ...
  Widget _buildAdditionalInfo(String currentStatus, Map<String, dynamic> userData) {
      ...
      case 'Student':
        return Column(
          ...
          children: [
            ...
            _buildUserInfo('Current Institution:', userData['current_institution']),
            _buildUserInfo('Expected Year of Passing:', userData['exp_year_of_passing']),
          ],
        );
